...
|---|---|---|---|
| DeepSeek Harness | `47f943859bef60e4160492346772ded9b24f765a` plus the local generic compatibility patch | MIT | Direct public API reuse; no DSH source is copied into this repository. |
