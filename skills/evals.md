...
- Reconnect case: reconnect by session scans configured Hosts, ordinary mux churn is cache-folded, material returns reconcile authoritatively, and stale interaction `rpcId` answers are rejected.
